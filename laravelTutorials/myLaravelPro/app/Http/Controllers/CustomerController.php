...
class CustomerController extends Controller
{
    ...
    public function store(Request $request){
		...
		$id = Customer::insertGetId(["user_name"=>$request['name'],"email"=>$request['email'] ,"gender"=>$request['gender'] , "address" =>  $request['address'] , "dob" => $request['dob'] , "password" => md5($request['password'])]);
		...
		//	//$id = $customer->id;
		//	//print_r(Customer::getPdo()->lastInsertId());
