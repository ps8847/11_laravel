            ...
            <section class="hero-section" id="section_1">
                ...
                <div class="video-wrap">
                    <video autoplay="" loop="" muted="" class="custom-video" poster="">
                        <source src="{{url('frontend/video/pexels-2022395.mp4')}}" type="video/mp4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="about-text-wrap">
                                <img src="{{url('frontend/images/pexels-alexander-suhorucov-6457579.jpg')}}" class="about-image img-fluid">
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-5 col-12">
                            <div class="artists-thumb">
                                <div class="artists-image-wrap">
                                    <img src="{{url('frontend/images/artists/joecalih-UmTZqmMvQcw-unsplash.jpg')}}" class="artists-image img-fluid">
                                </div>
                        ...
                        <div class="col-lg-5 col-12">
                            <div class="artists-thumb">
                                <div class="artists-image-wrap">
                                    <img src="{{url('frontend/images/artists/abstral-official-bdlMO9z5yco-unsplash.jpg')}}" class="artists-image img-fluid">
                                </div>
                            ...
                            <div class="artists-thumb">
                                <img src="{{url('frontend/images/artists/soundtrap-rAT6FJ6wltE-unsplash.jpg')}}" class="artists-image img-fluid">
